...
# Fatia a frase pegando apenas os caracteres da posição 3 e indo ate a posição 10
...
# O '.strip()' remove os espações que estão no inicio da frase e do final
...
print(f"A frase fica toda em caixa alta com o metodo .upper() -> {frase.upper()}")

# Usado para deixar a frase toda com as letras em caixa baixa
print(f"A frase fica toda em caixa baixa com metodo .lower() -> {frase.lower()}")
